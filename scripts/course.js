...
document.getElementById("showAll").addEventListener("click", () => renderCourses("all"));
document.getElementById("showWDD").addEventListener("click", () => renderCourses("wdd"));
document.getElementById("showCSE").addEventListener("click", () => renderCourses("cse"));
